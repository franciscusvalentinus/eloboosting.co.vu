...
<head>
  ...
  <meta name="description" content="Successfully Sent Joki League of Legends, Joki LoL #1 di Google">
  
  <title>Successfully Sent | eloboosting.co.vu</title>
...
<section class="menu cid-rYnMLFtTzS" once="menu" id="menu1-19">
...
<section class="cid-rYnMLGdDHc mbr-fullscreen" id="header2-1a">
    <div class="mbr-overlay" style="opacity: 0.5; background-color: rgb(35, 35, 35);"></div>
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">SUCCESSFULLY SENT</h1>
                <div class="mbr-section-btn"><a class="btn btn-md btn-white-outline display-4" href="index.php">BACK TO HOME</a></div>
            </div>
        </div>
    </div>
</section>

<section class="cid-rYnMLI5sq3" id="social-buttons2-1c">
    <div class="container">
...
<section once="" class="cid-rYnMLJ1mdw mbr-reveal" id="footer6-1d">
    <div class="container">
